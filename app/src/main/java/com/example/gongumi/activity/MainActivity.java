                        ...
                        if(postFragment.check()) {
                            ...
                            alert.setPositiveButton("확인", new DialogInterface.OnClickListener() {
                                ...
                                public void onClick(DialogInterface dialog, int which) {
                                    ...
                                    addPost(post);
                                    uploadProfilePhoto(post.getStartDay().getTime(), postFragment.adapter.getList());
                                    mTabLayout.setScrollPosition(0, 0f, true);
                                    mViewPager.setCurrentItem(0);
                                    post = new Post();
                                    post_pos = 0;
...
//                    Toast.makeText(SignUpActivity.this, "실패", Toast.LENGTH_SHORT).show();
    ...
    */
    ...
    public void uploadProfilePhoto(long time, ArrayList<Uri> list) {
...
//                                    uploadProfilePhoto(post.getStartDay().getTime(), postFragment.adapter.getList());
                                    mTabLayout.setScrollPosition(0, 0f, true);
                                    mViewPager.setCurrentItem(0);
                                    postFragment.adapter.clearList();
                                    post = new Post();
                                    post_pos = 0;
                                }
                            });
